...
fn integer_integer() {
    ...
    assert_eq!(res.as_integer().unwrap(), 6);
...
fn integer_float() {
    ...
    assert_approx_eq!(res.as_float(), 6.3)
}
...
fn float_float() {
    ...
    assert!(res.data().is_float());
    assert_approx_eq!(res.as_float(), 6.51);
...
fn float_integer() {
    ...
    assert!(res.is_float());
    assert_approx_eq!(res.as_float(), 6.2);
}
